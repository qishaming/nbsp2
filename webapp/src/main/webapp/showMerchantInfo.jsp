...
<head>
    ...
    <link href="<%=path%>/fisrtpage/css/seastyle.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="<%=path%>/fisrtpage/basic/js/jquery-1.7.min.js"></script>
    <script type="text/javascript" src="<%=path%>/fisrtpage/js/script.js"></script>
        ...
        <div class="am-g am-g-fixed">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <div class="search-content">
                    ...
                    <div class="clear"></div>
                    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes" id="showMerchantInfoznn">

                    </ul>
                    <%--这里是展示所有商品详情的--%>
                    <input type="hidden" name="gmid" value="${gmid}" id="gmidznn">
                    <script type="text/javascript">
                        $.ajax({
                            url:'<%=path%>/ZnnController/queryMerchantInfo.do',
                            type:"post",
                            data:{"gmid":$('#gmidznn').val()},
                            dataType:"json",
                            success:function(data){
                                ...
                                for(var i = 0; i < data.length; i++){
                                    ...
                                    html+="<img src='http://192.168.3.247:8080"+data[i].goodsimg+"' width='80px' height='160px'/>";
                                    html+= "<p class='title fl'>"+"【"+data[i].brandname+"】"+data[i].goodsScript+"</p>";
                                    html+= "<p class='price fl'>";
                                    html+=  "<b>¥</b>";
                                    html+= "<strong>"+data[i].goodsPrice+"</strong>";
                                    html+= "</p>";
                                ...
                                $("#showMerchantInfoznn").append(html);
                            }
                        })
                    </script>
                <div class="clear"></div>
