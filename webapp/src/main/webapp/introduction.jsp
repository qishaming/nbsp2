    ...
    <div class="scoll">
        <section class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="<%=path%>/fisrtpage/images/01.jpg" title="pic" />
                    </li>
                    <li>
                        <img src="<%=path%>/fisrtpage/images/02.jpg" />
                    </li>
                    <li>
                        <img src="<%=path%>/fisrtpage/images/03.jpg" />
                    </li>
                </ul>
            </div>
        </section>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="<%=path%>/fisrtpage/images/01.jpg"><img src="<%=path%>/fisrtpage/images/01_mid.jpg" alt="细节展示放大镜特效" rel="<%=path%>/fisrtpage/images/01.jpg" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="<%=path%>/fisrtpage/images/01_small.jpg" mid="<%=path%>/fisrtpage/images/01_mid.jpg" big="<%=path%>/fisrtpage/images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="<%=path%>/fisrtpage/images/02_small.jpg" mid="<%=path%>/fisrtpage/images/02_mid.jpg" big="<%=path%>/fisrtpage/images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="<%=path%>/fisrtpage/images/03_small.jpg" mid="<%=path%>/fisrtpage/images/03_mid.jpg" big="<%=path%>/fisrtpage/images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
