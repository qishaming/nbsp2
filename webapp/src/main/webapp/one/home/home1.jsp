	...
	<body>
		<div class="hmtop">
			...
			<div class="am-container header">
				...
				<div class="nav white">
					<div class="logo"><rimg src="../images/logo.png" /></div>
					<div class="logoBig">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
	...
	$.ajax({
		url:"<%=request.getContextPath()%>/new/queryremai.do",
		type:"post",
		dataType:"json",
		success:function (list){
			var span = "";
			$(list).each(function (){
				//margin-bottom设置下边距 两张图片上下之间的距离
				span+="<div style='width:130px;height:130px;float:left;margin-bottom:70px;'>" +
						"<a href='javaScript:fd("+this.goodsid +")'><img src='"+this.goodsimg+"' width='135px' height='135px'></a>" +
						"<font color='red'>商品</font>:<a href='javaScript:fd("+this.goodsid+")'>"+this.goodsname+"</a><br><font color='red'>￥" +
						"</font>"+this.goodsPrice +"</div><div style='width:20px;height:150px;float:left;'></div>"
			});
			$("#remai").html(span);
		},
		error:function (){
